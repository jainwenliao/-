...
def get_faces(window_name, camera_id, catch_pic_num, path):  
    ...
    #使用默认的人脸分类器
    classfier = cv2.CascadeClassifier(r'E:\\Opencv\\haarcascades_cuda\\haarcascade_frontalface_default.xml')
...
if __name__ == '__main__':
    if len(sys.argv) != 1: 
        ...
        get_faces('catch_faces',0,100, 'E:\\face_recognization_projects\\face_recognition\\test\\liaojianwen')

        get_faces('catch_faces',0,1000, 'E:\\face_recognization_projects\\face_recognition\\train\\liaojianwen')
'''
